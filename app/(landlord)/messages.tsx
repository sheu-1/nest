    ...
    try {
      const { data, error } = await supabase
        ...
        .select(`
          ...
          tenantProfile:profiles!conversations_tenant_id_fkey (id, name, avatar_url)
        `)
      ...
      if (data && data.length > 0) {
        const formatted: ConversationThread[] = data.map((d: any) => ({
          ...
          recipient: {
            id: d.tenantProfile?.id || 'tenant',
            name: d.tenantProfile?.name || 'Tenant Inquirer',
            avatar: d.tenantProfile?.avatar_url || 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&auto=format&fit=crop&q=80',
          }
        }));
    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      <View style={styles.header}>
        ...
        <Text variant="caption" color={COLORS.secondaryText}>
          Tenant inquiries about your listed properties
        </Text>
      </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              ...
              <Text variant="h3" style={{ marginTop: SPACING.md }}>No Inquiries Yet</Text>
              <Text variant="body" color={COLORS.secondaryText} style={{ marginTop: SPACING.sm, textAlign: 'center' }}>
                When tenants enquire about your active listings, their messages will appear here.
              </Text>
            </View>
          }
        />
